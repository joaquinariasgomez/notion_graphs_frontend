...
import { getExpensesCategories, getCategoryAverages, createBudget } from '../../api/RequestUtils';
import {
    MONTHS,
    formatEur,
        ...
        <div className='box__backdrop' onClick={closeBox}>
            <div className='createbudgetbox__container' onClick={(e) => e.stopPropagation()}>
                ...
                <div className='createbudgetbox__header'>
                    <h1>Create budget</h1>
                    <p>Set a target for a month, then fine-tune each category.</p>
                </div>
                ...
                {!dataLoading && (
                    <div className='createbudgetbox__footer'>
                        ...
                        <div className='createbudgetbox__footer__actions'>
                            ...
                            >
                                {isSaving ? <ClipLoader size={18} color='#ffffff' /> : 'Create budget'}
                            </button>
                        </div>
                    </div>
                )}
